...
public:
    ...
    ElementsStateTypes ResidentDriverState;        // Состояние резидента механика-водителя
    ElementsStateTypes ResidentGunnerState;        // Состояние резидента стрелка-наводчика
    ElementsStateTypes MotionSystemDriverState;    // Состояние системы подвижности механика-водителя
    ElementsStateTypes MotionSystemGunnerState;    // Состояние системы подвижности стрелка-наводчика
